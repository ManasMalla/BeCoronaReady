...
public class JigsawPuzzleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView puzzleImageView = findViewById(R.id.puzzleImageView);
    ...
    private ArrayList<PuzzlePiece> splitImage() {
        ...
        ImageView imageView = findViewById(R.id.puzzleImageView);
        ...
        if (isGameOver()) {
            ...
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    ...
                    startActivity(new Intent(JigsawPuzzleActivity.this, GameWinActivity.class));
                }
            };
